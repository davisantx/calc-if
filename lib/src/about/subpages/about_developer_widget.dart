...
class AboutDeveloperWidget extends StatefulWidget {
  const AboutDeveloperWidget({super.key});

  @override
  State<AboutDeveloperWidget> createState() => _AboutDeveloperWidgetState();
}

class _AboutDeveloperWidgetState extends State<AboutDeveloperWidget> {
  bool reverse = false;
  bool visible = false;
